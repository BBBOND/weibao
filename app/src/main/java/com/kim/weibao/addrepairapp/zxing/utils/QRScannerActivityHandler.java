...
package com.kim.weibao.addrepairapp.zxing.utils;
 ...
 */
public class QRScannerActivityHandler extends Handler {
	...
	public QRScannerActivityHandler(QRScannerActivity activity, CameraManager cameraManager, int decodeMode) {
